...
`,P=t=>{let o=document.createElement("style");o.innerHTML=S,document.head.appendChild(o);let e=document.createElement("div");e.classList.add("debugIcon"),e.innerHTML="DEBUG",document.body.appendChild(e),e.addEventListener("click",()=>{t.forEach(s=>{s.classList.add("signElement"),setTimeout(()=>{s.classList.remove("signElement")},3e3)})})},_=P;var q=(t,o)=>{if(!Object.keys(t).length)return a.error("No components passed");Object.keys(t).forEach(e=>{let s=t[e];if(console.log(e),!e)return a.error("Component name not defined, please give a name to your component");m.has(e)&&a.warn(`Name collision detected. ${e} was previously defined`),m.set(e,s)}),document.addEventListener("DOMContentLoaded",function(){a.info(`Initializing ${g}`),x(o)})};var dt=q;export{_ as debug,dt as default};
